...
<html lang="en">
  ...
  <body>
    ...
    <center>
            <p style="font-size: 20px; margin-top: 1.5em; margin-bottom: 1.5em; background-color: black; color: white;">Bienvenid@ <b><?php echo"".$_SESSION['nom'];?></b></p>
    </center>

    <!--Cupon Descuento-->
    <div class="row">
        <center>
            <p style="font-size: 20px; margin-top: 1.5em; margin-bottom: 1.5em; background-color: black; color: yellow;"><b>CYBERMONDAY 3 - 4 - 5 OCTUBRE</b></br>  Utiliza el código <b>cyb3r25</b> para un 25% de descuento</p>
        </center>
    </div>

    <!--Carrusel-->
    <img src="ofe.jpg" class="d-block w-100" alt="..." style="width: 10%;">
